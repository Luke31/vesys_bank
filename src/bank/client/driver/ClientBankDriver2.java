...
public interface ClientBankDriver2 extends ClientBankDriver {
	...
	interface UpdateHandler {
		/**
		 * The accountChanged method is invoked whenever an account changes on the server side, i.e. if an account is
		 * created, closed or if its balance changes.
		 * 
		 * @param id
