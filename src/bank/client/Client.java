 ...
 * which implements the <code>BankDriver</code> interface has to be specified. This class is then loaded and used to
 * access the bank. This class needs a public constructor.
 * 
 * <pre>
 * Usage: java bank.Client &lt;classname&gt;
 * </pre>
 * 
 * E.g. start the application with one of the following commands. The additional runtime arguments are passed to the
 * connect method of the BankDriver implementation.
 * 
 * <pre>
