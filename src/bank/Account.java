...
/**
 * The Account interface represents a single account. It can be used to deposit and withdraw money. The amounts are
 * always given in Swiss Francs. References to accounts can be obtained over a bank interface.
 * 
 * @see Bank
...
public interface Account {
	...
	/**
	 * Returns the state of the account. An account may be active or passive. A fresh created account is active. When the
	 * account is deleted, it becomes passive. Transactions performed on a passive account are not allowed and throw an
	 * InactiveException.
	 * 
	 ...
	 * <code>InactiveException</code> is never thrown when the balance is accessed.
	 * 
