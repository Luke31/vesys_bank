 ...
 * interface and then requests the bank.
 * 
 * @see Bank
...
public interface BankDriver {
	...
	/**
	 * Return the bank which is served by that server. Before getBank can be invoked, connect must be called. getBank must
	 * have singleton semantics, i.e. it should return the same instance upon subsequent calls. After disconnect has been
	 * called getBank returns null.
	 * 
